...
class ModelsController extends Contorler {
  ...
  createRouter (config) {
    ...
    const gen = function *() {
      ...
      yield this.bindMiddlewares(rootRouter, opts)
      ...
      if (settings.get('showModels', false) === true) {
        rootRouter.get('/models', this.createMiddleware(this.models))
      }
      ...
      // rootRouter.all('/*', this.createMiddleware(superDisable))
  ...
  models (ctx) {
    ...
    return this.respond(ctx, { body: models || {} })
