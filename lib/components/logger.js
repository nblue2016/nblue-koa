...
class LoggerComponent extends Component {
  ...
  create (options) {
    ...
    napp.saveToCache(Constants.KeyOfLogger, logger)
  ...
  express () {
    ...
    return function (req, res, next) {
      ...
      napp.once(Constants.EventOfSessionEnd, () => {
        ...
        // append info to logger
        logger.verbose(generateFunc(opts))
      })
