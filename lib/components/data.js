...
class DataComponent extends Component {
  ...
  get DatabaseConfig () {
    ...
    return config.has(CONFIG_KEY_OF_DATABASE)
  ...
  get ConnectionStringsConfig () {
    ...
    // check database section in config
    return config.has(CONFIG_KEY_OF_CONNECTIONS)
      ? config.get(CONFIG_KEY_OF_CONNECTIONS)
      : new Map()
  }
  ...
  create () {
    ...
    const gen = function *() {
      ...
      const packages = DbConnections.getPackages(installOpts)
