...
class ModelComponent extends Component
{
  ...
  get ModelConfig () {
    ...
    return modelCache.has(Constants.KeyOfConfig)
      ? modelCache.get(Constants.KeyOfConfig)
      : new Map()
  }
  ...
  get ModelSettings () {
    ...
    return modelCache.has(Constants.KeyOfSettings)
      ? modelCache.get(Constants.KeyOfSettings)
      : new Map()
  }

  get ModelCache () {
    const cacheKey = this.CacheKey
    const modelCache = this.NBlue.AppCache
  ...
  create () {
    ...
    return co(function *() {
      ...
      modelCache.set(Constants.KeyOfConfig, modelConfig)
      modelCache.set(Constants.KeyOfSettings, settings)
